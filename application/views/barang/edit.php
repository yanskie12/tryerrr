        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input value="<?= set_value('kdBarang', $barang->kdBarang); ?>" type="text" 
                    id="kdBarang" name="kdBarang" class="form-control" placeholder="Masukkan Kode">
                    <?= form_error('kdBarang'); ?>
                </div>
                <div class="form-group">
                    <label for="namaBarang">Nama Barang</label>
                    <input value="<?= set_value('namaBarang', $barang->namaBarang); ?>" type="text" 
                    id="namaBarang" name="namaBarang" class="form-control" placeholder="Nama Barang">
