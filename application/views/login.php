...
<body>
    ...
    <div class="mb-4 text-center">
        ...
        <center><img src="<?php echo base_url('assets/img/2.png') ?>" width="400px" height="180px "></center>
        <p class="small text-muted">Silahkan Login</p>
    </div>
    ...
    <p class="mt-3 mb-3 text-muted text-center">&copy; <?= date('Y') ?> Minimarket Damar</p>
    <?= form_close(); ?>
